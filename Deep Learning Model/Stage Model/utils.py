...
def draw_train(train_loss, val_loss, test_loss, ccc_train, ccc_val, ccc_test, rho_train, rho_val, rho_test):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f'./model/{model_id}/training_metrics.png')
    plt.close()
...
def draw_true_and_pred(y_true, y_pred, name):
    ...
    plt.savefig(f'./model/{model_id}/true_vs_predicted_' + name + '.png')
    plt.close()
...
def draw_confusion_matrix(y_true, y_pred, name):
    ...
    plt.savefig(f'./model/{model_id}/confusion_matrix_' + name + '.png')
    plt.close()
...
def draw_roc(y_true, y_pred, filter, name):
    ...
    plt.savefig(f'./model/{model_id}/roc_curve_' + name + '_' + str(filter) + '.png')
    plt.close()
